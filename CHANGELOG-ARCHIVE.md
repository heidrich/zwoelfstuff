...
Versions before 4.70.0, moved out of [CHANGELOG.md](CHANGELOG.md) on
2026-08-16 so that file stays under the size GitHub accepts as a release
body. Same format, same wording, nothing rewritten.
