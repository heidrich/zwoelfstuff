...
ns.CHANGELOG = {
    {
        ...
        lines = {
            ...
            "",
            "THE SPELL NAME'S POSITION WAS SIMPLY NOT READ. Both renderers anchored it hard to the left and threw the setting away. All nine positions and both nudges work, inside the space the icon leaves it.",
            "",
